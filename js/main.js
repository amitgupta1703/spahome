...
function callOtpInput(e) {
    console.log(e);
    var target = e.target.previousElementSibling;
    console.log(target.value);
    $.ajax({
        url: 'codes/enter-otp.php',
        type: 'POST',
        data: {
            otp: target.value,
            submit_otp_becomepartner: 'yes'
        },
...
function openPopup() {
    ...
    span.onclick = function () {
        modal.style.display = "none";
        window.location.href = "become-partner.php";
    }
...
jQuery(document).ready(function ($) {
    ...
    var siteCarouselBanner = function () {
    ...
    var siteCarousel = function () {
        if ($('.owl-carousel-s').length > 0) {
            $('.owl-carousel-s').owlCarousel({
                center: false,
                items: 1,
                loop: true,
                stagePadding: 0,
    ...
    var siteCarouselTestmonial = function () {
