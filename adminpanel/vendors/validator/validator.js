...
function locationDe(e) {
    ...
    if (e.target.value == "office") {
        document.getElementById("officeLocation").innerHTML = '<div  class="form-group"> <input type="text" class="form-control col-md-6 col-xs-12" placeholder="Office Location" name="location"  /> </div';
    } else {
