                  ...
                  <div class="x_content">
                    ...
                    <form  method="post" action="edit-services.php?service_id=<?php echo $service_id ?>" data-parsley-validate=""  class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data" > 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="services_name" id="services_name" class="form-control col-md-7 col-xs-12" onChange="locationDe(event)">
                                ...
                                <option value="Salon For Women">Salon For Men Services</option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea  id="services_description" name="services_description" class="form-control col-md-7 col-xs-12" ><?php echo $services_description ?></textarea>
                        </div>
                      </div>  
