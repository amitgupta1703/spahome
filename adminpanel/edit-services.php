...
if(isset($_GET['service_id']) && isset($_GET['editmode'])=='true'){
  ...
  echo '<script>(function(){window.location.href ="posted-services.php";})();</script>';
}
?>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form  method="post" action="edit-services.php?service_id=<?php echo $service_id;  ?>&editmode=true" class="form-horizontal form-label-left" enctype="multipart/form-data" novalidate> 
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="services_name" name="services_name" value="<?php echo $services_name;?>" class="form-control col-md-7 col-xs-12"> 
                        </div>
                      </div>
                      ...
                      <div class="form-group" id="cat">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                              <?php if($data['subcategory']){echo explode(',',$data['subcategory'])[1];};?>
                        </div>
                      </div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="duration" name="duration" value="<?php  echo $duration;?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <textarea id="services_description" id="services_description" name="services_description" required="required" value="" class="form-control col-md-7 col-xs-12 txtarea"><?php  echo $services_description;?></textarea>
                        </div>
                      </div> 
                     ...
                     <!--  <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="amount" required="required" name="amount" value="<?php  echo $amount; ?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div> 
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="offersOrDiscount" id="offersOrDiscount" class="form-control col-md-7 col-xs-12">
                                  ...
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='5'){echo 'selected';} ?> value="5">5% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='10'){echo 'selected';} ?> value="10">10% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='15'){echo 'selected';} ?> value="15">15% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='20'){echo 'selected';} ?> value="20">20% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='25'){echo 'selected';} ?> value="25">25% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='30'){echo 'selected';} ?> value="30">30% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='35'){echo 'selected';} ?> value="35">35% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='40'){echo 'selected';} ?> value="40">40% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='45'){echo 'selected';} ?> value="45">45% Off</option>
                                  <option <?php if($offersOrDiscount!='' && $offersOrDiscount=='50'){echo 'selected';} ?> value="50">50% Off</option> 
                            </select> 
                          </div> 
                      </div> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="hidden" id="imagesUrls" required="required" name="imagesUrls" value="<?php  echo $data['services_image']; ?>" class="form-control col-md-7 col-xs-12">
                        <?php 
                                if($data['services_image']!=""){
                                    $imgs=explode(',',$data['services_image']);
                                  
                                    $len=count($imgs);
                                    for($i=0;$i<$len;$i++){
                                        if($imgs[$i]!=""){
                                            echo ' <img src="../services_img/'.$imgs[$i].'" alt="" height="90" width="120" border="1px">';
                                        }
                                    }
                                  }
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                           ...
                           <input type="submit" class="btn btn-success" name="post_services_update" value="Update Services">;
